...
> **Total Codebase**: ~7,400 lines of Rust
...
│  (1493 lines)   │    │  (973 lines)    │    │   (598 lines)   │
│                 │    │                 │    │                 │
...
└─────────────────┘    └─────────────────┘    └─────────────────┘
         ...
         ▼                       ▼
┌─────────────────┐    ┌─────────────────┐    ┌─────────────────┐
│  builder.rs     │    │  importer.rs    │    │  pipeline.rs    │
│  (243 lines)    │    │  (370 lines)    │    │  (391 lines)    │
│                 │    │                 │    │                 │
│ • Cargo Gen     │    │ • Git Import    │    │ • Var Resolution│
│ • WASM Compile  │    │ • Gist Import   │    │ • Conditions    │
└─────────────────┘    └─────────────────┘    └─────────────────┘
                                                      │
                              ┌────────────────────────┘
                              ▼
